...
(test-equal "no matching patterns" (match (list 1 2) ((a b c **1) c) (else "no matching patterns")))
...
(test-equal "no matching patterns" (match (list 1 2 3 4 5 6) ((a b *.. 2 4) b) (else "no matching patterns")))
...
(test-equal "no matching patterns" (match (list 1 2) ((a b =.. 2)  b) (else "no matching patterns")))
(test-equal '(2 3) (match (list 1 2 3) ((a b =.. 2)  b)))
(test-equal "no matching patterns" (match (list 1 2 3 4) ((a b =.. 2)  b) (else "no matching patterns")))
